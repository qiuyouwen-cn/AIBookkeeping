...
object AIParser {
    ...
    private val timeOfDayKeywords = mapOf(
        ...
        "上午" to 10 to 0,     // 10:00
        "中午" to 12 to 0,     // 12:00
        "午饭" to 12 to 0,     // 12:00 (午饭时间)
        "午餐" to 12 to 0,     // 12:00
        "下午" to 15 to 0,     // 15:00
        "傍晚" to 18 to 0,     // 18:00
        "晚上" to 19 to 30,    // 19:30
        "晚饭" to 18 to 30,    // 18:30 (晚饭时间)
        "晚餐" to 18 to 30,    // 18:30
        "夜里" to 22 to 0,     // 22:00
        "深夜" to 23 to 30,    // 23:30
        "早餐" to 7 to 30,     // 7:30 (早餐时间)
        "早饭" to 7 to 30,     // 7:30
        "宵夜" to 22 to 30,    // 22:30
        "夜宵" to 22 to 30     // 22:30
    )
